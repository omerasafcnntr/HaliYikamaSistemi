    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (SqlConnection baglanti = new SqlConnection(baglantiCumlesi))
            {
                ...
                // Müşteriyi kaydet ve oluşan yeni MusteriID'yi geri döndür
                string musteriSorgu = @"
                ...
                // Yakaladığımız MusteriID ile Siparişi kaydet
                ...
                // Tabloyu anında yeni verilerle güncelle
                SiparisleriListele();
                txtAdSoyad.Text = "";
                txtTelefon.Text = "";
                txtMetrekare.Text = "";
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            if (secilenMusteriID > 0)
            {
                using (SqlConnection baglanti = new SqlConnection(baglantiCumlesi))
                {
                    ...
                    //Siparişler tablosunu güncelle (Metrekare ve Tutarı baştan hesapla)
                    decimal metrekare = Convert.ToDecimal(txtMetrekare.Text);
